...
then
    ...
    export GEN_JUPYTER_PASS_CMD="from notebook.auth import passwd; print(passwd('${JUPYTER_PASSWORD}'))"
    JUPYTER_PASSWORD_HASH=$(python3 -c "${GEN_JUPYTER_PASS_CMD}")
    unset GEN_JUPYTER_PASS_CMD
