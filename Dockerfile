...
RUN apt-get update \
    ...
    && apt-get autoremove \
    && apt-get clean \
    && pip3 install -U j2cli jupyter jupyterlab==1.0.0a6 six matplotlib scikit-learn plotly \
    && pip3 install tornado==5.1.1  # https://stackoverflow.com/questions/54956350/unable-to-start-jupyter-notebook-typeerror
